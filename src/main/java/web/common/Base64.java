...
public class Base64 {
     ...
     * @throws InvalidParameterException if the parameter supplied is not of
     *             type byte[]
     */
    ...
    public String encode(String plainText) {
        try {
            return new String(encode(plainText.getBytes(CHARSET)), CHARSET);
    ...
    public String decode(String cipherText) {
        try {
            return new String(decode(cipherText.getBytes(CHARSET)), CHARSET);
        } catch (UnsupportedEncodingException e) {
            return cipherText;
        }
    }
